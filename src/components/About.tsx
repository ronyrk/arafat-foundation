...
import { GraduationCap, HandHeart, TriangleRight, UserRound } from 'lucide-react';
			...
			<div className=" basis-3/5 px-1">
				...
				<div className="py-2 flex flex-row md:gap-x-2 gap-x-1">
					...
					<div className=" basis-1/3  hover:text-color-sub border-[1px] shadow-lg border-color-main py-6 rounded-sm flex justify-center items-center flex-col">
						<h2 className=" font-normal  hover:text-color-sub"><HandHeart size={80} strokeWidth={2} absoluteStrokeWidth /></h2>
						<h2 className=" text-[22px] font-semibold">সেবা</h2>
					</div>
					<div className=" basis-1/3  hover:text-color-sub border-[1px] shadow-lg border-color-main py-6 rounded-sm flex justify-center items-center flex-col">
						<h2 className=" font-normal  hover:text-color-sub"><UserRound size={80} strokeWidth={2} absoluteStrokeWidth /></h2>
