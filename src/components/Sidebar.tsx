...
function Sidebar() {
	...
	return (
		<div className='flex flex-col bg-gray-100 border-2 rounded'>
			...
			<Link className={` px-4 py-3 text-[15px]  font-semibold rounded-md  ${subRoutes === "donor-and-lenders" ? " bg-color-main text-white" : " hover:bg-gray-200 hover:text-black text-black"}`} href="/karze-hasana/donor-and-lenders">Donor & Lenders</Link>
