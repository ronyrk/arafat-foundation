...
function HeaderSlider() {
	...
	return (
		<div className=" bg-color-main">
			<div className='md:px-20 px-4 h-100 flex flex-row justify-between items-center py-2'>

				<Image sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" src={logo} className='md:mr-4 mr-1 border-dashed rounded border-white md:pr-4 pr-1 border-r-2 md:w-32 w-16  h-10' alt='logo' placeholder='blur' />
				<div className="">
