...
function page() {
	return (
		<div className='px-2'>
			...
			<p className=" leading-relaxed font-semibold">কর্জে হাসানা/সুদ বিহীন ঋণ সম্পূর্ণ আলাদা একটি কার্যক্রম।  আমাদের কর্জে হাসানা/সুদ বিহীন ঋণ  সম্পর্কে বিস্তারিত জানতেএখানে <Link prefetch={false} className=' text-blue-400' href="/karze-hasana"> ক্লিক</Link> করুন।</p>
		</div>
	)
}
