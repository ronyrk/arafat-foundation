...
function page() {
  return (
    <div className="md:mx-20 md:my-4 my-2">
      <div className="flex md:flex-row flex-col gap-2">
        <div className="basis-1/2 mt-36">
          <Card className="w-1000">
            <CardHeader>
              ...
              <p className="text-xl font-normal border-b-2  border-gray-200 pb-2 ">
                Enter your details and we&lsquo;ll get back to you.
              </p>
            </CardHeader>
            <CardContent>
              <FeedBack />
        ...
        <div className=" basis-1/2 mt-36">
          <div className="max-w-md h-[525px] mx-auto bg-white p-6 rounded-lg shadow flex flex-col justify-around">
            <h2 className="text-2xl font-semibold border-b-2 border-gray-200 pb-4">
              Contact Info
            </h2>
            <div className="mt-2">
              ...
              <div className="flex items-center space-x-3 mt-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Yousufpur, Charghat, Rajshahi-6271, Bangladesh
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="p-4">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d58144.75383517318!2d88.56496015505027!3d24.379664360314155!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fbefa96a38d031%3A0x10f93a950ed6f410!2sRajshahi!5e0!3m2!1sen!2sbd!4v1710786811381!5m2!1sen!2sbd"
          className="w-full"
          height="300"
          loading="lazy"
        ></iframe>
